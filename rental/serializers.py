    ...
    class Meta:
        ...
        def to_representation(self, rental_contact):
            ...
            if "room" in self.fields and room:
                data["room"] = {
                    "id": rental_contact.bed.room.id,
                    "name": rental_contact.bed.room.name,
                    "image": rental_contact.bed.room.image,
                    "number_of_bed": rental_contact.bed.room.number_of_bed,
                    "type": rental_contact.bed.room.type,
                    "room_for": rental_contact.bed.room.room_for,
                    "created_date": rental_contact.bed.room.created_date,
                    "updated_date": rental_contact.bed.room.updated_date,
                }
